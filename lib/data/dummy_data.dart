...
class SiajDummyData {
  ...
  /// User
  static final  UserModel user = UserModel.empty(); // Need to add data on constructor
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
        ...
        description: 'This is a product description for Blue Nike Sleeve less vest. There are more things that can be added but i am just practising nothing else',
        brand: BrandModel(
            id: '6',
    ...
    ProductModel(
        ...
        isFeatured: false,
        thumbnail: SiajImages.productImage69,
        description: 'This is a product description for Leather brown Jacket. There are more things that can be added but i am just practising nothing else.',
        brand: BrandModel(
            id: '6',
            image: SiajImages.zaraLogo,
            name: 'ZARA'),
